...
# prediction endpoint (fix double slash)
predict_url = "http://16.171.43.22:8000/predict"
...
if response.status_code == 200:
    ...
    predicted_time = response_json["predicted_delivery_time"]
    print(f"The prediction value by the API is {predicted_time:.2f} min")
else:
